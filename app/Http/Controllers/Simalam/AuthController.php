...
class AuthController extends Controller
{
    public function showLogin(Request $request)
    {
        ...
        return view('absensi.admin.login', [
            'loginRole' => $loginRole,
            'activeAuthMode' => $activeAuthMode,
            'bidangs' => Bidang::orderBy('name', 'asc')->pluck('name'),
            'bidangOptions' => Bidang::orderBy('name', 'asc')->get(),
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::user()->role === 'superadmin') {
            return redirect()->route('absensi.admin.dashboard')->with('success_swal', 'Login Super Admin berhasil!');
        }

        if (Auth::user()->role === 'admin') {
            return redirect()->route('home')->with('success_swal', 'Login Admin berhasil!');
        }
    ...
    private function redirectAuthenticatedUser(Request $request)
    {
        ...
        if ($user->role === 'admin') {
            return redirect()->route('absensi.admin.dashboard', ['tab' => 'pegawai']);
        }
