...
@section('title', 'Form Absensi - LENTERA Kab Bogor')
        ...
        <div class="col-lg-5 col-md-7">
            ...
            <div class="glass-card p-4">
                ...
                <form action="{{ route('absensi.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label class="form-label form-label-premium">Proyek / Modul Pekerjaan Saat Ini</label>
                        <div class="input-group">
                            <span class="input-group-text bg-light text-primary border-end-0"><i class="fa-solid fa-list-check"></i></span>
                            <input type="text" class="form-control form-control-premium bg-light border-start-0 text-dark fw-bold" value="{{ $assignedProjectName ?? 'Website absensi' }}" readonly disabled style="cursor: not-allowed;">
                        </div>
                        <div class="form-text" style="font-size:0.75rem;"><i class="fa-solid fa-lock me-1 text-secondary"></i> Ditugaskan oleh Admin / Pembimbing (Read Only).</div>
                    </div>
