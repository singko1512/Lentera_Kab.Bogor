...
<li><span class="material-symbols-outlined text-[16px] mx-1">chevron_right</span></li>
<li aria-current="page" class="text-primary font-medium">Penelitian (Instansi / Lembaga Lainnya)</li>
</ol>
</nav>
<h1 class="font-headline-lg text-headline-lg text-primary mt-2">Form Pengajuan Penelitian (Instansi / Lembaga Lainnya)</h1>
...
<p class="font-body-md text-body-md text-on-surface-variant font-semibold">Penelitian (Instansi / Lembaga Lainnya)</p>
...
<div class="flex flex-col gap-stack-sm md:col-span-2">
<label class="font-label-md text-label-md text-on-surface">Jenis Permohonan Rekomendasi <span class="text-error">*</span></label>
<p class="font-caption text-caption text-on-surface-variant">Silakan pilih salah satu</p>
<select name="jenis_permohonan" class="rounded-lg border-outline-variant bg-surface-bright focus:border-secondary focus:ring focus:ring-secondary/20 font-body-md text-body-md p-3 text-on-surface" required>
...
<p class="font-caption text-caption text-on-surface-variant">Apabila peserta lebih dari 5 (lima) orang, harap mencantumkan daftar nama dalam dokumen terpisah berformat PDF.</p>
<input name="atas_nama" class="rounded-lg border-outline-variant bg-surface-bright focus:border-secondary focus:ring focus:ring-secondary/20 font-body-md text-body-md p-3 text-on-surface" placeholder="Masukkan nama perwakilan / instansi" type="text" required value="{{ auth()->check() ? auth()->user()->nama : '' }}">
</div>
<div class="flex flex-col gap-stack-sm md:col-span-2">
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-stack-md mt-2">
<div class="flex flex-col gap-stack-sm md:col-span-2">
<label class="font-label-md text-label-md text-on-surface">Judul Penelitian / Pengambilan Data / Wawancara / Survei / Pelaksanaan Kegiatan <span class="text-error">*</span></label>
<input name="judul_kegiatan" class="rounded-lg border-outline-variant bg-surface-bright focus:border-secondary focus:ring focus:ring-secondary/20 font-body-md text-body-md p-3 text-on-surface" placeholder="Masukkan judul" type="text" required>
</div>
<div class="flex flex-col gap-stack-sm md:col-span-2">
<label class="font-label-md text-label-md text-on-surface">Waktu Pelaksanaan <span class="text-error">*</span></label>
<p class="font-caption text-caption text-on-surface-variant">(Penelitian / Pengambilan Data / Wawancara / Survei / Pelaksanaan Kegiatan)<br/>Contoh: 17 Agustus 2021 s.d. 17 Oktober 2021.<br/>Masa berlaku maksimal 3 (tiga) bulan. Apabila kegiatan berlangsung lebih dari 3 (tiga) bulan, wajib mengajukan perpanjangan dengan mencantumkan surat rekomendasi yang telah diterbitkan sebelumnya.</p>
</div>
...
<label class="flex flex-col gap-stack-sm p-4 border-2 border-dashed border-outline-variant rounded-xl bg-surface-bright hover:bg-surface-container-low transition-colors text-center cursor-pointer relative overflow-hidden">
<input type="file" name="file_surat_pengantar" accept="application/pdf" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" required>
<span class="material-symbols-outlined text-4xl text-secondary mx-auto">draft</span>
<span class="font-label-md text-label-md text-primary mt-2">Surat Pengantar / Permohonan Asli dari Instansi / Lembaga</span>
<span class="font-caption text-caption text-outline">Surat harus ditujukan kepada Kepala Badan Kesbangpol Kabupaten Bogor. Format file: PDF. Wajib *</span>
</label>
<label class="flex flex-col gap-stack-sm p-4 border-2 border-dashed border-outline-variant rounded-xl bg-surface-bright hover:bg-surface-container-low transition-colors text-center cursor-pointer relative overflow-hidden">
...
<span class="font-label-md text-label-md text-primary mt-2">Surat dari Lokasi Pelaksanaan Kegiatan</span>
...
<span class="font-label-md text-label-md text-primary mt-2">Proposal Penelitian / Pengambilan Data / Wawancara / Survei / Pelaksanaan Kegiatan</span>
<span class="font-caption text-caption text-outline">Format file: PDF. Wajib *</span>
</label>
<label class="flex flex-col gap-stack-sm p-4 border-2 border-dashed border-outline-variant rounded-xl bg-surface-bright hover:bg-surface-container-low transition-colors text-center cursor-pointer relative overflow-hidden">
<input type="file" name="file_surat_kesbangpol_jabar" accept="application/pdf" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" required>
<span class="material-symbols-outlined text-4xl text-secondary mx-auto">account_balance</span>
<span class="font-label-md text-label-md text-primary mt-2">Surat Keterangan Penelitian dari Badan Kesbangpol Provinsi Jawa Barat</span>
<span class="font-caption text-caption text-outline">Format file: PDF. Wajib *</span>
</label>
<label class="flex flex-col gap-stack-sm p-4 border-2 border-dashed border-outline-variant rounded-xl bg-surface-bright hover:bg-surface-container-low transition-colors text-center cursor-pointer relative overflow-hidden">
<input type="file" name="file_surat_kemendagri" accept="application/pdf" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" required>
<span class="material-symbols-outlined text-4xl text-secondary mx-auto">gavel</span>
<span class="font-label-md text-label-md text-primary mt-2">Surat Keterangan Penelitian dari Direktorat Jenderal Politik dan Pemerintahan Umum (Ditjen Polpum) Kementerian Dalam Negeri</span>
<span class="font-caption text-caption text-outline">Format file: PDF. Wajib *</span>
</label>
...
<input type="file" name="file_pendukung" accept="application/pdf" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer">
<span class="material-symbols-outlined text-4xl text-secondary mx-auto">attach_file</span>
<span class="font-label-md text-label-md text-primary mt-2">Dokumen Pendukung Lainnya</span>
<span class="font-caption text-caption text-outline">Format file: PDF. (Opsional)</span>
</label>
