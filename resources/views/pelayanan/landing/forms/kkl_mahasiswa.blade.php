...
<li><span class="material-symbols-outlined text-[16px] mx-1">chevron_right</span></li>
<li aria-current="page" class="text-primary font-medium">KKL / PKL / Magang (Mahasiswa)</li>
</ol>
</nav>
<h1 class="font-headline-lg text-headline-lg text-primary mt-2">Form Pengajuan KKL / PKL / Magang (Mahasiswa)</h1>
...
<p class="font-body-md text-body-md text-on-surface-variant font-semibold">KKL / PKL / Magang (Mahasiswa)</p>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-stack-md mt-2">
<div class="flex flex-col gap-stack-sm md:col-span-2">
<label class="font-label-md text-label-md text-on-surface">Waktu Pelaksanaan KKL / PKL <span class="text-error">*</span></label>
...
<input name="tempat_kegiatan" class="rounded-lg border-outline-variant bg-surface-bright focus:border-secondary focus:ring focus:ring-secondary/20 font-body-md text-body-md p-3 text-on-surface" placeholder="Masukkan lokasi atau dinas tujuan KKL/PKL" type="text" required list="instansi-list">
</div>
</div>
</div>
...
<span class="font-label-md text-label-md text-primary mt-2">Surat dari Lokasi KKL / PKL</span>
...
<span class="font-label-md text-label-md text-primary mt-2">Proposal KKL / PKL</span>
<span class="font-caption text-caption text-outline">Format file: PDF. Wajib *</span>
</label>
