...
<li><span class="material-symbols-outlined text-[16px] mx-1">chevron_right</span></li>
<li aria-current="page" class="text-primary font-medium">KKL / PKL / Magang (Siswa Sekolah)</li>
</ol>
</nav>
...
<p class="font-body-md text-body-md text-on-surface-variant font-semibold">KKL / PKL / Magang (Siswa Sekolah)</p>
...
<p class="font-caption text-caption text-on-surface-variant">(SMA / SMK / MA / Sederajat)</p>
<input name="asal_instansi" class="rounded-lg border-outline-variant bg-surface-bright focus:border-secondary focus:ring focus:ring-secondary/20 font-body-md text-body-md p-3 text-on-surface" placeholder="Contoh: SMA Negeri 1 Cibinong" type="text" required value="{{ auth()->check() ? auth()->user()->asal_instansi : '' }}">
</div>
</div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-stack-md mt-2">
<div class="flex flex-col gap-stack-sm md:col-span-2">
<label class="font-label-md text-label-md text-on-surface">Waktu Pelaksanaan KKL / PKL / Magang <span class="text-error">*</span></label>
...
<div class="flex flex-col gap-stack-sm md:col-span-2">
<label class="font-label-md text-label-md text-on-surface">Tempat Pelaksanaan KKL / PKL / Magang <span class="text-error">*</span></label>
<input name="tempat_kegiatan" class="rounded-lg border-outline-variant bg-surface-bright focus:border-secondary focus:ring focus:ring-secondary/20 font-body-md text-body-md p-3 text-on-surface" placeholder="Masukkan lokasi atau dinas tujuan PKL" type="text" required list="instansi-list">
</div>
</div>
</div>
...
<input type="file" name="file_ktp" accept="application/pdf" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer">
...
<label class="flex flex-col gap-stack-sm p-4 border-2 border-dashed border-outline-variant rounded-xl bg-surface-bright hover:bg-surface-container-low transition-colors text-center cursor-pointer relative overflow-hidden">
<input type="file" name="file_kartu_pelajar" accept="application/pdf" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer">
<span class="material-symbols-outlined text-4xl text-secondary mx-auto">id_card</span>
<span class="font-label-md text-label-md text-primary mt-2">Upload Kartu Pelajar</span>
<span class="font-caption text-caption text-outline">Format file: PDF. Opsional</span>
</label>
<label class="flex flex-col gap-stack-sm p-4 border-2 border-dashed border-outline-variant rounded-xl bg-surface-bright hover:bg-surface-container-low transition-colors text-center cursor-pointer relative overflow-hidden">
...
<span class="font-label-md text-label-md text-primary mt-2">Surat dari Lokasi KKL / PKL / Magang</span>
...
<label class="font-label-md text-label-md text-on-surface">Keterangan (Opsional)</label>
