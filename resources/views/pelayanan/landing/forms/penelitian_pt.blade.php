...
<li><span class="material-symbols-outlined text-[16px] mx-1">chevron_right</span></li>
<li aria-current="page" class="text-primary font-medium">Penelitian (Perguruan Tinggi)</li>
</ol>
</nav>
<h1 class="font-headline-lg text-headline-lg text-primary mt-2">Form Pengajuan Penelitian (Perguruan Tinggi)</h1>
...
<p class="font-body-md text-body-md text-on-surface-variant font-semibold">Penelitian (Perguruan Tinggi)</p>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-stack-md mt-2">
<div class="flex flex-col gap-stack-sm md:col-span-2">
<label class="font-label-md text-label-md text-on-surface">Judul Penelitian / Kegiatan <span class="text-error">*</span></label>
<input name="judul_kegiatan" class="rounded-lg border-outline-variant bg-surface-bright focus:border-secondary focus:ring focus:ring-secondary/20 font-body-md text-body-md p-3 text-on-surface" placeholder="Masukkan judul penelitian / kegiatan" type="text" required>
</div>
<div class="flex flex-col gap-stack-sm md:col-span-2">
<label class="font-label-md text-label-md text-on-surface">Waktu Penelitian / Kegiatan <span class="text-error">*</span></label>
...
<div class="flex flex-col gap-stack-sm md:col-span-2">
<label class="font-label-md text-label-md text-on-surface">Tempat Penelitian / Kegiatan <span class="text-error">*</span></label>
<input name="tempat_kegiatan" class="rounded-lg border-outline-variant bg-surface-bright focus:border-secondary focus:ring focus:ring-secondary/20 font-body-md text-body-md p-3 text-on-surface" placeholder="Masukkan lokasi atau dinas tujuan" type="text" required list="instansi-list">
</div>
</div>
</div>
...
<span class="font-caption text-caption text-outline">Wajib dilampirkan bagi mahasiswa. Format file: PDF. Wajib *</span>
</label>
<label class="flex flex-col gap-stack-sm p-4 border-2 border-dashed border-outline-variant rounded-xl bg-surface-bright hover:bg-surface-container-low transition-colors text-center cursor-pointer relative overflow-hidden">
...
<span class="font-label-md text-label-md text-primary mt-2">Surat Permohonan</span>
<span class="font-caption text-caption text-outline">Ditujukan kepada Kepala Badan Kesbangpol. Format file: PDF. Wajib *</span>
</label>
<label class="flex flex-col gap-stack-sm p-4 border-2 border-dashed border-outline-variant rounded-xl bg-surface-bright hover:bg-surface-container-low transition-colors text-center cursor-pointer relative overflow-hidden">
...
<span class="font-label-md text-label-md text-primary mt-2">Surat dari Lokasi Penelitian / Kegiatan</span>
...
<span class="font-label-md text-label-md text-primary mt-2">Proposal Penelitian / Kegiatan</span>
<span class="font-caption text-caption text-outline">Format file: PDF. Wajib *</span>
</label>
