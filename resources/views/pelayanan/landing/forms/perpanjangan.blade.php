...
<li><span class="material-symbols-outlined text-[16px] mx-1">chevron_right</span></li>
<li aria-current="page" class="text-primary font-medium">Perpanjangan Izin Rekomendasi</li>
</ol>
</nav>
<h1 class="font-headline-lg text-headline-lg text-primary mt-2">Form Pengajuan Perpanjangan Izin Rekomendasi</h1>
...
<p class="font-body-md text-body-md text-on-surface-variant font-semibold">Perpanjangan Izin Rekomendasi</p>
...
<input name="tempat_kegiatan" class="rounded-lg border-outline-variant bg-surface-bright focus:border-secondary focus:ring focus:ring-secondary/20 font-body-md text-body-md p-3 text-on-surface" placeholder="Masukkan tempat penelitian / kegiatan" type="text" required list="instansi-list">
</div>
</div>
</div>
...
<label class="flex flex-col gap-stack-sm p-4 border-2 border-dashed border-outline-variant rounded-xl bg-surface-bright hover:bg-surface-container-low transition-colors text-center cursor-pointer relative overflow-hidden">
<input type="file" name="file_surat_rekomendasi_lama" accept="application/pdf" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" required>
