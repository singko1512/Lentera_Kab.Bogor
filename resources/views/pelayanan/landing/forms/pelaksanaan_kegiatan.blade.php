...
<li><span class="material-symbols-outlined text-[16px] mx-1">chevron_right</span></li>
<li aria-current="page" class="text-primary font-medium">Pelaksanaan Kegiatan</li>
</ol>
</nav>
<h1 class="font-headline-lg text-headline-lg text-primary mt-2">Form Pengajuan Pelaksanaan Kegiatan</h1>
...
<p class="font-body-md text-body-md text-on-surface-variant font-semibold">Pelaksanaan Kegiatan</p>
...
<div class="flex flex-col gap-stack-sm md:col-span-2">
<label class="font-label-md text-label-md text-on-surface">Asal Institusi / Organisasi / Komunitas <span class="text-error">*</span></label>
<input name="asal_instansi" class="rounded-lg border-outline-variant bg-surface-bright focus:border-secondary focus:ring focus:ring-secondary/20 font-body-md text-body-md p-3 text-on-surface" placeholder="Contoh: Universitas Indonesia / Karang Taruna" type="text" required value="{{ auth()->check() ? auth()->user()->asal_instansi : '' }}">
</div>
</div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-stack-md mt-2">
<div class="flex flex-col gap-stack-sm md:col-span-2">
<label class="font-label-md text-label-md text-on-surface">Tema / Judul Pelaksanaan Kegiatan <span class="text-error">*</span></label>
<input name="judul_kegiatan" class="rounded-lg border-outline-variant bg-surface-bright focus:border-secondary focus:ring focus:ring-secondary/20 font-body-md text-body-md p-3 text-on-surface" placeholder="Masukkan tema / judul pelaksanaan kegiatan" type="text" required>
</div>
<div class="flex flex-col gap-stack-sm md:col-span-2">
<label class="font-label-md text-label-md text-on-surface">Waktu Pelaksanaan Kegiatan <span class="text-error">*</span></label>
...
<div class="flex flex-col gap-stack-sm md:col-span-2">
<label class="font-label-md text-label-md text-on-surface">Tempat Pelaksanaan Kegiatan <span class="text-error">*</span></label>
<input name="tempat_kegiatan" class="rounded-lg border-outline-variant bg-surface-bright focus:border-secondary focus:ring focus:ring-secondary/20 font-body-md text-body-md p-3 text-on-surface" placeholder="Masukkan tempat pelaksanaan kegiatan" type="text" required list="instansi-list">
</div>
</div>
</div>
...
<label class="flex flex-col gap-stack-sm p-4 border-2 border-dashed border-outline-variant rounded-xl bg-surface-bright hover:bg-surface-container-low transition-colors text-center cursor-pointer relative overflow-hidden">
<input type="file" name="file_id_card" accept="application/pdf" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer">
<span class="material-symbols-outlined text-4xl text-secondary mx-auto">id_card</span>
<span class="font-label-md text-label-md text-primary mt-2">Upload ID Card / Surat Penunjukan / SK</span>
<span class="font-caption text-caption text-outline">Jika perwakilan instansi atau organisasi. Format file: PDF. Opsional</span>
</label>
<label class="flex flex-col gap-stack-sm p-4 border-2 border-dashed border-outline-variant rounded-xl bg-surface-bright hover:bg-surface-container-low transition-colors text-center cursor-pointer relative overflow-hidden">
...
<span class="font-label-md text-label-md text-primary mt-2">Surat dari Lokasi Kegiatan</span>
...
<span class="font-label-md text-label-md text-primary mt-2">Proposal / Lampiran Pelaksanaan Kegiatan</span>
<span class="font-caption text-caption text-outline">Format file: PDF. Wajib *</span>
</label>
