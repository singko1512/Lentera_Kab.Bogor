...
<head>
    ...
    <title>@yield('title', 'LENTERA Kab Bogor - Dashboard Admin')</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* Responsive tweaks for admin dashboard */
...
<body>
    @include('pelayanan.partials.sidebar_kesbangpol')

    <div class="main-content" style="margin-left: 280px; min-height: 100vh; display: flex; flex-direction: column; background: #f8fafc;">
        <div style="flex: 1; padding: 2rem;">
            @yield('content')
        </div>

        <footer class="admin-footer">
            &copy; {{ date('Y') }} LENTERA Kab Bogor &middot; Layanan Integrasi Izin Riset dan Magang Kabupaten Bogor
        </footer>
    </div>
