...
@section('title', 'LENTERA Kab Bogor - Layanan Integrasi Izin Riset dan Magang Kabupaten Bogor')
...
<style>
    ...
    .card-employee {
        background: linear-gradient(160deg, #bfdbfe 0%, #3b82f6 40%, #115cb9 100%);
        color: #fff;
    }
    ...
    .card-admin .feature-icon {
        background: rgba(17, 92, 185, 0.12);
        color: var(--primary);
    }
    ...
    .admin-login-actions a:hover {
        background: rgba(17, 92, 185, 0.16);
        color: var(--primary);
    }
    ...
    .schedule-bidang-tab.active {
        ...
        color: #fff;
        box-shadow: 0 2px 8px rgba(17, 92, 185, 0.28);
    }
    ...
    .schedule-table tbody td.is-today {
        background: rgba(17, 92, 185, 0.04);
    }
...
<div class="container">
    ...
    <div class="hero-section">
        ...
        <p class="hero-sub">
            Layanan Integrasi Izin Riset dan Magang Kabupaten Bogor untuk mencatat kehadiran, mengirim laporan pekerjaan, dan memantau performa tim.
        </p>
    </div>
                                            ...
                                            @foreach ($bidangUsers as $user)
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="rounded-circle d-flex align-items-center justify-content-center fw-bold" 
                                                                style="width:28px; height:28px; background:rgba(17, 92, 185, 0.1); color:var(--primary); font-size:0.75rem;">
                                                                {{ strtoupper(substr($user->nama, 0, 1)) }}
                                                            </div>
                                                            <div>
                                                                <div class="fw-bold text-dark" style="font-size:0.85rem;">{{ $user->nama }}</div>
